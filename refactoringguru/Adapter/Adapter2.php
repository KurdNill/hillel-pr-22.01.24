...
//Sent email with title 'Website is down!' to 'developers@example.com' that says
...
//Posted following message into the 'Example.com Developers' chat:
// '#Website is down!# Alert! Our website is not responding. Call admins and bring it up!'.

$slack = new SlackApi("example.com", "XXXXXXXX");
$notification = new SlackNotification($slack, "Example.com Developers");
clientCode($notification);